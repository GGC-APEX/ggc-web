      ...
      + '<div id="exit-card" style="position:relative;width:100%;max-width:480px;background:#151331;border-radius:20px;overflow:hidden;transform:scale(0.9);transition:transform 0.4s cubic-bezier(0.4,0,0.2,1);box-shadow:0 25px 60px rgba(0,0,0,0.5),0 0 40px rgba(139,92,246,0.08)">'
        ...
        + '<div style="padding:40px 32px 36px">'
          ...
          + '<form id="exit-form">'
            ...
            + '<label style="display:flex;align-items:flex-start;gap:8px;cursor:pointer;margin-bottom:12px"><input type="checkbox" name="privacy" required style="margin-top:4px;accent-color:#8B5CF6"><span style="font-family:\'DM Sans\',system-ui,sans-serif;font-size:12px;color:#6b7280">Acepto la <a href="/privacidad" style="text-decoration:underline;color:#6b7280" onmouseenter="this.style.color=\'#fff\'" onmouseleave="this.style.color=\'#6b7280\'">pol\u00edtica de privacidad</a>. Recibir\u00e9 comunicaciones que puedo cancelar en cualquier momento.</span></label>'
